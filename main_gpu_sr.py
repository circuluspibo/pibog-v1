...
model_txt = snapshot_download(repo_id='circulus/Qwen3-VL-4B-it-ov-awq') #circulus/gemma-3-4b-it-ov-awq  # helenai/Qwen3-VL-4B-Instruct-int4 Echo9Zulu/gemma-3-4b-it-qat-int4_asym-ov circulus/gemma-3-4b-it-ov-awq-sym helenai/Qwen2.5-VL-3B-Instruct-ov-int4
